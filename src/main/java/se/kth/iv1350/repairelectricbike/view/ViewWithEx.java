...
public class ViewWithEx {
     ...
     */
    public ViewWithEx(Controller controller) {
    ...
    public void sampleExecution() throws CustomerRegistryException {
        ...
        for (RepairTaskDTO task : diagnosticReportDTO.getRepairTasks()) {
            repairTask.append("[").append(task.getRepairTaskDescription()).append(", ").append(task.getCostToRepair())
                    .append("], ");
        }
        repairTask.append("]");
